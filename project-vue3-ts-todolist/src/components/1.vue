  ...
  <div class="gdb-input" :class="{
    ...
    <div class="gdb-input__inner" :class="{ 'gdb-input__inner--focus': isFocus }">
      ...
      <div class="gdb-input__input-wrapper">
        <input v-model="value" :type="state.inputType" class="gdb-input__input" :placeholder="placeholder"
          :disabled="state.isDisabled" @focus="focusEvent" @blur="blurEvent" @change="changeEvent" />
